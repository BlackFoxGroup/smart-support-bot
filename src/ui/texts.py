...
MODE_DETAIL_BASIC: dict[Lang, str] = {
    "fa": (
        ...
        "• نصب پنل 3X-UI مبتنی بر Xray روی سرور مرکزی (گزینهٔ اصلی)\n"
        "• WireGuard برای لینک مش / تست کلاینت در کنار آن در دسترس است\n"
    ...
    "en": (
        ...
        "• Install the Xray-based 3X-UI panel on the central server (primary)\n"
        "• WireGuard remains available for mesh links / client test\n"
    ...
    "ru": (
        ...
        "• Установка панели 3X-UI на базе Xray на Central (основной вариант)\n"
        "• WireGuard остаётся для mesh / теста клиента\n"
    ...
    "zh": (
        ...
        "• 在中心服务器安装基于 Xray 的 3X-UI 面板（主选项）\n"
        "• WireGuard 仍可用于 Mesh 链路 / 客户端测试\n"
